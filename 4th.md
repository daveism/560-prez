...
As an example, I converted the wind speed measured in knots to MPH, because it's easier for me to relate to MPH [clean_data_functions.R](clean_data_functions.R#L206).
